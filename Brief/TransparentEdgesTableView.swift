...
class TransparentEdgesTableView: UITableView {
    ...
    func refreshGradient() {
        ...
        if !showTopMask && !showBottomMask {
            let arrayColors: Array <AnyObject> = [innerColor.CGColor, innerColor.CGColor, innerColor.CGColor, innerColor.CGColor]
            maskLayer.colors = arrayColors
        } else if showTopMask && !showBottomMask {
            let arrayColors: Array <AnyObject> = [outerColor.CGColor, innerColor.CGColor, innerColor.CGColor, innerColor.CGColor]
            maskLayer.colors = arrayColors
        } else if !showTopMask && showBottomMask {
            let arrayColors: Array <AnyObject> = [innerColor.CGColor, innerColor.CGColor, innerColor.CGColor, outerColor.CGColor]
            maskLayer.colors = arrayColors
        } else if showTopMask && showBottomMask {
            let arrayColors: Array <AnyObject> = [outerColor.CGColor, innerColor.CGColor, innerColor.CGColor, outerColor.CGColor]
            maskLayer.colors = arrayColors
        }
